...
namespace  {
    ...
    use Illuminate\Database\Query\array as QueryArray;
    ...
    class Eloquent extends Model {
         ...
         * @return ($id is (Arrayable<array-key, mixed>|array<mixed>) ? EloquentCollection<int, TModel> : TModel|null)
         * @static
         */
         ...
         * @param mixed $id
         * @param array|string $columns
         * @return ($id is (Arrayable<array-key, mixed>|array<mixed>) ? EloquentCollection<int, TModel> : TModel)
         * @throws ModelNotFoundException<TModel>
         * @static
         */
         ...
         *
         * @param Expression|array|string $attributes
         * @param mixed $value
         ...
         *
         * @param Model|EloquentCollection<int, Model> $related
         ...
         *
         * @param Closure|QueryBuilder|Builder<*>|Expression|string $table
         ...
         *
         * @param Expression|string|array $first
         * @param string|null $operator
         ...
         *
         * @param Closure|QueryBuilder|Builder<*> $callback
         * @param string $boolean
         * @param bool $not
         * @return Builder<static>
         * @static
         ...
         *
         * @param Expression[]|Closure[]|string[] $columns
         * @param mixed $operator
         * @param mixed $value
         * @param string $boolean
         * @return Builder<static>
         ...
         *
         * @param Expression|Closure|string $column
         * @param DateTimeInterface|string|int|float|null $operator
         * @param Expression|DateTimeInterface|string|int|float|null $value
         * @param string $boolean
         * @return Builder<static>
         * @static
         */
         ...
         *
         * @param Closure|QueryBuilder|Builder<*>|Expression|string $column
         ...
         *
         * @param Closure|QueryBuilder|Expression|string|null $column
         * @param string $direction
         * @return Builder<static>
         * @static
         */
         ...
         *
         * @param Closure|QueryBuilder|Builder<*> $query
         * @param bool $all
         * @return Builder<static>
         * @static
         */
         ...
         *
         * @return QueryArray{ select: list<mixed>,
         *      from: list<mixed>,
         *      join: list<mixed>,
         *      where: list<mixed>,
         *      groupBy: list<mixed>,
